...
> **Implemented in Spec 004:** state variables (`sanity`, `trust`, boolean flags) are live and
> gate which options the engine exposes at each node.
...
| 008+ | Menu + Achievements | Main menu, continue flow, endings gallery |
| 009+ | App Intents / Siri | Apple Intelligence integration, Shortcuts |
